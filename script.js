...
// It should look like: https://script.google.com/macros/s/XXXXXX/exec
// NOT a Google Sheets edit URL!
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzGwHxOdKaLyfRCeeMb9nTvfKLJrr1fZCpGZ6z_e6j1k7aZ9e3jk4KUYl4uH3fJJCLE/exec";
...
function isScriptConfigured() {
  return (
    SCRIPT_URL &&
    !SCRIPT_URL.includes("PASTE_YOUR_GOOGLE_APPS_SCRIPT_WEB_APP_URL_HERE") &&
...
async function handleContactSubmit(event) {
  ...
  const loadingMsg = currentLang === "kn" ? "ಕಳುಹಿಸಲಾಗುತ್ತಿದೆ..." : "Sending...";
